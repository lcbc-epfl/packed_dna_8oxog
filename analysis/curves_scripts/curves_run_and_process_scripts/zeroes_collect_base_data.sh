...
for f in /scratch/sojohnso/fs_2023/clean_run_8og_bur_ox/3step_curves/20_notails_curves_data/zeroes/*
do
	(cd "$f"
	cp ../../../each_bp.sh .
	./each_bp.sh
...
mv ./20_notails_curves_data/zeroes/*csv ./output_bybase
